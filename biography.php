...
<?php get_header(); ?>
	...
	<div class="row">
		<div class="eight columns">
			...
			<div class="quote">
				<h4>"Behind every funny man is an even funnier woman who's been writing his material"</h4>
			</div>
			
				<p><span class="bold">Wendi McLendon-Covey was born October 10th, 1969 in Bellflower California.</span></p>
					...
					with their cats Darla, Maxine, Crash and Hunter.</p>
					<p>For a full list of Wendi's roles and appearances check out her<a href="http://www.imdb.com/name/nm1018488/"> IMDB Profile</a>.</p>
			</div><!-- bio container -->
		</div><!-- eleven columns -->
